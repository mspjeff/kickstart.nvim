...
winget install --id zig.zig --source winget --exact
winget install --id BurntSushi.ripgrep.MSVC --source winget --exact
```

### Install Neovim ###

```
winget install --id Neovim.Neovim --source winget --exact
```
